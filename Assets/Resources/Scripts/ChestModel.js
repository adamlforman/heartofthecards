var owner : ChestScript;  //IS THIS SCOPE NECESSARY?

function init(o : ChestScript) {
	...
	name = "Chest Model"; //Name the object.
	
	textureName = "Textures/chest"; //Get the texture name with texture folder
