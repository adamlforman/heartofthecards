var owner : VromScript;  //IS THIS SCOPE NECESSARY?

function init(o : VromScript) {
	...
	name = "Vrom Model"; //Name the object.
	
	textureName = "Textures/fast"; //Get the texture name with texture folder
